...
USERBOT_HELP = f"""{emoji.LABEL}  **Ƙɑɑℓ Coɱɱoŋ Coɱɱʌŋɗs**:
...
USERBOT_REPO = f"""{emoji.ROBOT} **Ƙɑɑℓ Voɩcɘ Cʜʌt Usɘʀɓot**

- Repository: [GitHub](https://github.com/kaalware/KaalMusicBot)
